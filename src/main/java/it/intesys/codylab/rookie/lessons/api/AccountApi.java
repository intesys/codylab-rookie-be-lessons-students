...
public class AccountApi {
    ...
    List<AccountDto> getAccounts (@RequestParam ("page") Integer page,
                                  @RequestParam("size") Integer size, @RequestParam("sort") String sort, @Nullable @RequestBody String filter){
     {
          if(page == null)
              page=0;
